...
import RegistrationModal from '../modals/registration-modal/registration-modal'
...
const Header: React.FC<PropsType> = ({ authOpen, setAuthOpen }) => {
  const { user, isAuth, isLoading, isNavbarOpen, isLogModalOpen, isRegModalOpen } = useAppSelector(getAuthState)
