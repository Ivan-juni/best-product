...
import { fetchSearchProducts } from 'store/slices/product/product.action-creators'
import { fetchSearchCategories } from 'store/slices/categories/categories.action-creators'
