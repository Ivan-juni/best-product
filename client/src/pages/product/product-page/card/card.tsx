...
import {
  ...
  deleteLike,
  fetchFavoritesIds,
} from 'store/slices/favorites/favorites.action-creators'
import { editProduct, fetchProducts } from 'store/slices/product/product.action-creators'
...
const Card: React.FC<PropsType> = ({ product, isEditMode, changeMainImage, addImage, deleteImage }) => {
  ...
  const { likes, dislikes, views, ids: favorites } = useAppSelector(getFavoritesState)
